...
def Keyword_1(sIn):  # Функция Keyword_1 принимает строку 'sIn' в качестве аргумента
    if sIn != "" and not (sIn is None) and sIn != "...":
        extractor = KeywordExtractor(
            lan="ru", n=1, top=10, features=None
        ...
        return "; ".join(
            [word[0] for word in keywords]
        ).capitalize()  # Объединяем ключевые слова с использованием ';' в качестве разделителя и делаем первую букву каждого слова заглавной
